...
@include('layout.sidebar')
            <div id="main-content">
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{route('tampiltabungan', $data->tabungan_id)}}" method="POST" enctype="multipart/form-data" class="form form-horizontal">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="kelas_id" class="form-control"
                                                name="kelas_id" value="{{$data->nama_kelas}}">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="number" id="jlh_setoran" class="form-control"
                                                name="jlh_setoran" value="{{$data->jlh_setoran}}">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="date" id="tgl_setoran" class="form-control"
                                                name="tgl_setoran" value="{{$data->tgl_setoran}}">
                                        </div>
                                        <div class="col-md-4">
                                            <label>Payment</label>
                                        </div>
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="no_rekening" class="form-control"
                                                name="no_rekening" value="{{$data->NISN}}">
                                        </div>
